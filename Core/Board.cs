...
namespace ChessEngine
{
    ...
    public class Board
    {
        ...
        public void UndoMove(Move move)
        {
            ...
            if ((move.Flags & MoveFlags.Castling) != 0)
            {
                if (movedPiece == Piece.WK)
                {
                    if (to == 6)
                    {
                        MovePiece(5, 7, Piece.WR);
                    }
                    else if (to == 2)
                    {
                        MovePiece(3, 0, Piece.WR);
                    }
                }
                else if (movedPiece == Piece.BK)
                {
                    if (to == 62)
                    {
                        MovePiece(61, 63, Piece.BR);
                    }
                    else if (to == 58)
                    {
                        MovePiece(59, 56, Piece.BR);
                    }
                }
            }
        ...
        public bool IsSquareAttacked(int square, bool byWhite)
        {
            ...
            if (byWhite)
            {
                if ((Bitboard.PawnAttacks[1][square] & WP) != 0)
                {
                    return true;
                }
                if ((Bitboard.KnightAttacks[square] & WN) != 0)
                {
                    return true;
                }
                if ((Bitboard.KingAttacks[square] & WK) != 0)
                {
                    return true;
                }
                if ((MagicBitboards.GetBishopAttacks(square, AllPieces) & (WB | WQ)) != 0)
                {
                    return true;
                }
                if ((MagicBitboards.GetRookAttacks(square, AllPieces) & (WR | WQ)) != 0)
                {
                    return true;
                }
            }
            ...
            {
                if ((Bitboard.PawnAttacks[0][square] & BP) != 0)
                {
                    return true;
                }
                if ((Bitboard.KnightAttacks[square] & BN) != 0)
                {
                    return true;
                }
                if ((Bitboard.KingAttacks[square] & BK) != 0)
                {
                    return true;
                }
                if ((MagicBitboards.GetBishopAttacks(square, AllPieces) & (BB | BQ)) != 0)
                {
                    return true;
                }
                if ((MagicBitboards.GetRookAttacks(square, AllPieces) & (BR | BQ)) != 0)
                {
                    return true;
                }
            }
